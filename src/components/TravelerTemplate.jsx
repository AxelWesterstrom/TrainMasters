...
function TravelerTemplate({personId}) {
  ...
  console.log("this is PEOPLE LIST APPERANTELY", s.ticket.people[personId].type)
  console.log("THIS IS PERSONID",s.ticket.people[0].type)

  return (
    <>
      <Container>
        <Col className="person">
          <p className="custom-label">Resenär {personId + 1}: {s.ticket.people[personId].type }</p>
        </Col>
          ...
          <Row className="">
            <Container>
              ...
              <Col className="text-center col-xs-12 col-md-5 col-md-3 col-xl-3">
                <input className="nameInput firstNameInput" type="text" required  />
              </Col>
